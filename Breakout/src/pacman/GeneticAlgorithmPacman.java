...
import utils.GameController;
	...
	public class GeneticAlgorithmPacman {
		...
		private int inputDim = utils.Commons.PACMAN_STATE_SIZE;
		private int outputDim =utils.Commons.PACMAN_NUM_ACTIONS; 
		...
		private int swap_rate = 2;

		private int curSeed;

		private NN best;

		public GeneticAlgorithmPacman(int hiddenDim, int PopSize, int seed) {
			curSeed = seed;
			...
			List<NN> firstPop = genFirstPop();
			this.population = firstPop;
...
//				}
				...
				for (int i = 0; i < PopSize; i++) {
					PacmanBoard b = new PacmanBoard(population.get(i), false, curSeed);
					b.setSeed(curSeed);
					b.runSimulation();
			...
			Pacman gg = new Pacman(best,true, curSeed);
